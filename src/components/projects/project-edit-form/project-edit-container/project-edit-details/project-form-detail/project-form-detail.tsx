...
class Modifier {
  ...
  const ProjectFormDetail: React.FC<ProjectFormDetailProps> = ({ type, isReadonly, details }) => {
    ...
    const typeModifier = new Map([
      ...
      [
        'start-date',
        new Modifier('Start Date: ', 'date', workPkg.startDate.toLocaleDateString())
      ],
      [
        'end-date',
      ...
      ['slide-deck', new Modifier('Slide Deck: ', 'link', 
          (details.slideDeckLink == "") ? 'Enter Link Here...' : details.slideDeckLink)],
      ['task-list', new Modifier('Task List: ', 'link', 
          (details.taskListLink == "") ? 'Enter Link Here...' : details.taskListLink)],
      ['bom', new Modifier('BOM: ', 'link', 
          (details.bomLink == "") ? 'Enter Link Here...' : details.bomLink)],
      ['google-drive', new Modifier('Google Drive: ', 'link', 
